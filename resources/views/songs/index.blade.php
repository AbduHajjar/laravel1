            ...
            <ul class="divide-y divide-gray-200">
                ...
                <li class="flex justify-between items-center py-4">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('songs.show', $song->id) }}" class="bg-green-500 text-white py-1 px-3 rounded">Show</a>
                        <a href="{{ route('songs.edit', $song->id) }}" class="bg-yellow-500 text-white py-1 px-3 rounded">Edit</a>
